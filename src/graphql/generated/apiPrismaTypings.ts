...
interface NexusPrismaInputs {
  Query: {
    users: {
  filtering: 'id' | 'email' | 'name' | 'role' | 'posts' | 'AND' | 'OR' | 'NOT' | 'profile'
  ordering: 'id' | 'email' | 'name' | 'role'
}
    profiles: {
  filtering: 'id' | 'bio' | 'userId' | 'AND' | 'OR' | 'NOT' | 'user'
  ordering: 'id' | 'bio' | 'userId'
}
    posts: {
  filtering: 'id' | 'createdAt' | 'title' | 'published' | 'authorId' | 'categories' | 'AND' | 'OR' | 'NOT' | 'author'
  ordering: 'id' | 'createdAt' | 'title' | 'published' | 'authorId'
}
    categories: {
  filtering: 'id' | 'name' | 'posts' | 'AND' | 'OR' | 'NOT'
  ordering: 'id' | 'name'
}
